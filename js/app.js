...
class Enemy extends RectRenderer {
     ...
     */
    get shapeRects() {
        let relationMatrix = this.direction === TO_LEFT ?
            enemiesManager.shapeRelationMatrix[0] :
            enemiesManager.shapeRelationMatrix[1];
     ...
     */
    render() {
        let enemyImage = this.direction === TO_RIGHT ?
            spriteImages.enemyToRight : spriteImages.enemyToLeft;
